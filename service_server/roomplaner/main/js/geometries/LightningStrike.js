 ...
 *
 * @param {function} onSubrayCreation This is another callback, more simple than the previous one. It can be used to adapt the form of subrays or other parameters once a subray has been created and initialized. It is used in the main to adapt subrays to a sphere or to a plane.
 *
 *
*/
...
THREE.LightningStrike.prototype.createDefaultSubrayCreationCallbacks = function () {
	...
	this.onDecideSubrayCreation = function ( segment, lightningStrike ) {
		...
		if ( isActive ) {
			...
			// Distribution items: probability *= segment.fraction0 > 0.5 && segment.fraction0 < 0.9 ? 1 / 0.4 : 0;
