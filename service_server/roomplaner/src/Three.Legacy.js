...
export var SceneUtils = {
	...
	createMultiMaterialObject: function ( /* geometry, materials */ ) {
		...
		console.error( 'THREE.SceneUtils has been moved to /main/jsm/utils/SceneUtils.js' );
...
export function LensFlare() {
	...
	console.error( 'THREE.LensFlare has been moved to /main/jsm/objects/Lensflare.js' );
