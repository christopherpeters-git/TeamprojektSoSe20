  ...
  "THREE": {
    ...
    "Material": {
      ...
      "prototype": {
        ...
        "depthTest": {
          "!type": "bool",
          "!doc": "Whether to have depth items enabled when rendering this material. Default is *true*."
        },
        "depthWrite": {
          "!type": "bool",
        ...
        "alphaTest": {
          "!type": "number",
          "!doc": "Sets the alpha value to be used when running an alpha items. Default is *0*."
        },
        "overdraw": {
          "!type": "number",
    ...
    "WebGLRenderer": {
      ...
      "prototype": {
        ...
        "enableScissorTest": {
          "!type": "fn(enable: bool)",
          "!doc": "Enable the scissor items. When this is enabled, only the pixels within the defined scissor area will be affected by further renderer actions."
        },
        "setClearColor": {
          "!type": "fn(color: +THREE.Color, alpha: number)",
