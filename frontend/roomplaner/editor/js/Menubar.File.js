...
import { ColladaExporter } from '../../main/jsm/exporters/ColladaExporter.js';
import { DRACOExporter } from '../../main/jsm/exporters/DRACOExporter.js';
import { GLTFExporter } from '../../main/jsm/exporters/GLTFExporter.js';
import { OBJExporter } from '../../main/jsm/exporters/OBJExporter.js';
import { PLYExporter } from '../../main/jsm/exporters/PLYExporter.js';
import { STLExporter } from '../../main/jsm/exporters/STLExporter.js';
...
var MenubarFile = function ( editor ) {
	...
	option.onClick( function () {
		...
		loader.load( '../main/jsm/webxr/VRButton.js', function ( content ) {

			zip.file( 'js/VRButton.js', content );

		} );
		loader.load( '../main/js/vr/HelioWebXRPolyfill.js', function ( content ) {
