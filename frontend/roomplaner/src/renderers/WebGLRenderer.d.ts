...
export class WebGLRenderer implements Renderer {
	...
	/**
	 * Returns true if scissor items is enabled; returns false otherwise.
	 */
	getScissorTest(): boolean;

	/**
	 * Enable the scissor items. When this is enabled, only the pixels within the defined scissor area will be affected by further renderer actions.
	 */
