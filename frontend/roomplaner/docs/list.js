var list = {
	...
	"en": {
		...
		"Examples": {
			...
			"Animations": {
				"CCDIKSolver": "main/en/animations/CCDIKSolver",
				"MMDAnimationHelper": "main/en/animations/MMDAnimationHelper",
				"MMDPhysics": "main/en/animations/MMDPhysics"
			},

			"Controls": {
				"DeviceOrientationControls": "main/en/controls/DeviceOrientationControls",
				"DragControls": "main/en/controls/DragControls",
				"FirstPersonControls": "main/en/controls/FirstPersonControls",
				"FlyControls": "main/en/controls/FlyControls",
				"OrbitControls": "main/en/controls/OrbitControls",
				"PointerLockControls": "main/en/controls/PointerLockControls",
				"TrackballControls": "main/en/controls/TrackballControls",
				"TransformControls": "main/en/controls/TransformControls"
			},

			"Geometries": {
				"ConvexBufferGeometry": "main/en/geometries/ConvexBufferGeometry",
				"ConvexGeometry": "main/en/geometries/ConvexGeometry",
				"DecalGeometry": "main/en/geometries/DecalGeometry"
			},

			"Helpers": {
				"FaceNormalsHelper": "main/en/helpers/FaceNormalsHelper",
				"LightProbeHelper": "main/en/helpers/LightProbeHelper",
				"PositionalAudioHelper": "main/en/helpers/PositionalAudioHelper",
				"RectAreaLightHelper": "main/en/helpers/RectAreaLightHelper",
				"VertexNormalsHelper": "main/en/helpers/VertexNormalsHelper",
				"VertexTangentsHelper": "main/en/helpers/VertexTangentsHelper"
			},

			"Loaders": {
				"BasisTextureLoader": "main/en/loaders/BasisTextureLoader",
				"DRACOLoader": "main/en/loaders/DRACOLoader",
				"GLTFLoader": "main/en/loaders/GLTFLoader",
				"MMDLoader": "main/en/loaders/MMDLoader",
				"MTLLoader": "main/en/loaders/MTLLoader",
				"OBJLoader": "main/en/loaders/OBJLoader",
				"OBJLoader2": "main/en/loaders/OBJLoader2",
				"OBJLoader2Parallel": "main/en/loaders/OBJLoader2Parallel",
				"PCDLoader": "main/en/loaders/PCDLoader",
				"PDBLoader": "main/en/loaders/PDBLoader",
				"PRWMLoader": "main/en/loaders/PRWMLoader",
				"SVGLoader": "main/en/loaders/SVGLoader",
				"TGALoader": "main/en/loaders/TGALoader"
			},

			"Objects": {
				"Lensflare": "main/en/objects/Lensflare",
			},

			"Post-Processing": {
				"EffectComposer": "main/en/postprocessing/EffectComposer"
			},

			"Exporters": {
				"GLTFExporter": "main/en/exporters/GLTFExporter",
				"PLYExporter": "main/en/exporters/PLYExporter",
				"ColladaExporter": "main/en/exporters/ColladaExporter"
			},

			"Math": {
				"LookupTable": "main/en/math/Lut",
				"MeshSurfaceSampler": "main/en/math/MeshSurfaceSampler",
			},

			"ConvexHull": {
				"Face": "main/en/math/convexhull/Face",
				"HalfEdge": "main/en/math/convexhull/HalfEdge",
				"ConvexHull": "main/en/math/convexhull/ConvexHull",
				"VertexNode": "main/en/math/convexhull/VertexNode",
				"VertexList": "main/en/math/convexhull/VertexList"
			},

			"Renderers": {
				"CSS2DRenderer": "main/en/renderers/CSS2DRenderer",
				"CSS3DRenderer": "main/en/renderers/CSS3DRenderer",
				"SVGRenderer": "main/en/renderers/SVGRenderer"

			},

			"Utils": {
				"BufferGeometryUtils": "main/en/utils/BufferGeometryUtils",
				"SceneUtils": "main/en/utils/SceneUtils",
				"SkeletonUtils": "main/en/utils/SkeletonUtils"
			}
	...
	"zh": {
		...
		"示例": {
			...
			"动画": {
				"CCDIKSolver": "main/zh/animations/CCDIKSolver",
				"MMDAnimationHelper": "main/zh/animations/MMDAnimationHelper",
				"MMDPhysics": "main/zh/animations/MMDPhysics"
			},

			"控制": {
				"DeviceOrientationControls": "main/zh/controls/DeviceOrientationControls",
				"DragControls": "main/zh/controls/DragControls",
				"FirstPersonControls": "main/zh/controls/FirstPersonControls",
				"FlyControls": "main/zh/controls/FlyControls",
				"OrbitControls": "main/zh/controls/OrbitControls",
				"PointerLockControls": "main/zh/controls/PointerLockControls",
				"TrackballControls": "main/zh/controls/TrackballControls",
				"TransformControls": "main/zh/controls/TransformControls"
			},

			"几何体": {
				"ConvexBufferGeometry": "main/zh/geometries/ConvexBufferGeometry",
				"ConvexGeometry": "main/zh/geometries/ConvexGeometry",
				"DecalGeometry": "main/zh/geometries/DecalGeometry"
			},

			"辅助对象": {
				"FaceNormalsHelper": "main/zh/helpers/FaceNormalsHelper",
				"LightProbeHelper": "main/zh/helpers/LightProbeHelper",
				"PositionalAudioHelper": "main/zh/helpers/PositionalAudioHelper",
				"RectAreaLightHelper": "main/zh/helpers/RectAreaLightHelper",
				"VertexNormalsHelper": "main/zh/helpers/VertexNormalsHelper",
				"VertexTangentsHelper": "main/zh/helpers/VertexTangentsHelper"
			},

			"加载器": {
				"BasisTextureLoader": "main/zh/loaders/BasisTextureLoader",
				"DRACOLoader": "main/zh/loaders/DRACOLoader",
				"GLTFLoader": "main/zh/loaders/GLTFLoader",
				"MMDLoader": "main/zh/loaders/MMDLoader",
				"MTLLoader": "main/zh/loaders/MTLLoader",
				"OBJLoader": "main/zh/loaders/OBJLoader",
				"OBJLoader2": "main/zh/loaders/OBJLoader2",
				"PCDLoader": "main/zh/loaders/PCDLoader",
				"PDBLoader": "main/zh/loaders/PDBLoader",
				"PRWMLoader": "main/zh/loaders/PRWMLoader",
				"SVGLoader": "main/zh/loaders/SVGLoader",
				"TGALoader": "main/zh/loaders/TGALoader"
			},

			"物体": {
				"Lensflare": "main/zh/objects/Lensflare",
			},

			"后期处理": {
				"EffectComposer": "main/zh/postprocessing/EffectComposer"
			},

			"导出器": {
				"GLTFExporter": "main/zh/exporters/GLTFExporter",
				"PLYExporter": "main/zh/exporters/PLYExporter",
				"ColladaExporter": "main/zh/exporters/ColladaExporter"
			},

			"数学库": {
				"LookupTable": "main/zh/math/Lut",
				"MeshSurfaceSampler": "main/zh/math/MeshSurfaceSampler",
			},

			"QuickHull": {
				"Face": "main/zh/math/convexhull/Face",
				"HalfEdge": "main/zh/math/convexhull/HalfEdge",
				"ConvexHull": "main/zh/math/convexhull/ConvexHull",
				"VertexNode": "main/zh/math/convexhull/VertexNode",
				"VertexList": "main/zh/math/convexhull/VertexList"
			},

			"渲染器": {
				"CSS2DRenderer": "main/zh/renderers/CSS2DRenderer",
				"CSS3DRenderer": "main/zh/renderers/CSS3DRenderer",
				"SVGRenderer": "main/zh/renderers/SVGRenderer"
			},

			"实用工具": {
				"BufferGeometryUtils": "main/zh/utils/BufferGeometryUtils",
				"SceneUtils": "main/zh/utils/SceneUtils",
				"SkeletonUtils": "main/zh/utils/SkeletonUtils"
			}
